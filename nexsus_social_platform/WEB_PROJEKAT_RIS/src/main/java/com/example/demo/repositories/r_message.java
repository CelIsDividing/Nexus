...
@Repository
public interface r_message extends JpaRepository<Message, Long> {
    ...
    List<Message> findByIdUser1AndIdUser2OrIdUser2AndIdUser1OrderBySentAt(User user1, User user2, User user2_2, User user1_2);
}