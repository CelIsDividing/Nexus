...
public class c_main {
    ...
    @Autowired
    private Generate_password generate_password;
    ...
    public String deniedPage(Authentication auth, Model model) {
    ...
    public String login(@RequestParam String username, 
                       ...
                       HttpSession session, 
                       Model model) {
        User user = s_user.find_by_username(username);
    ...
    public String register(@RequestParam String username,
                          ...
                          @RequestParam String password,
                          Model model) {
        if (s_user.find_by_username(username) != null) {
        ...
        user.setEmail(email);
        user.setPassword(generate_password.encode(password));
        s_user.save(user);
